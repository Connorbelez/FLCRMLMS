...
import { mortgagesAllView } from 'src/engine/workspace-manager/standard-objects-prefill-data/views/mortgages-all.view';
...
export const prefillCoreViews = async ({
  ...
  const views = [
    ...
    mortgagesAllView(objectMetadataItems, true),
